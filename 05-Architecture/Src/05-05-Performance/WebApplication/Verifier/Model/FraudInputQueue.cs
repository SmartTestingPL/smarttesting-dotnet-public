...
/// więc musiałem zaimplementować prymitywnę wersję tego mechanizmu samemu.
/// Uwaga: to nie jest reprezentatywny przykład, jak produkcyjnie
/// łączyć się z RabbitMq.
/// </summary>
public sealed class FraudInputQueue : IFraudInputQueue
{
  private readonly ILogger<FraudInputQueue> _logger;
  private IModel? _channel;
  private IConnection? _connection;

  public FraudInputQueue(
    IOptions<RabbitMqConfiguration> options,
    ILogger<FraudInputQueue> logger)
  {
    _logger = logger;
    Policy
      .Handle<Exception>()
  ...
  public void Register(IFraudListener listener)
  {
    ...
    consumer.Received += (model, ea) =>
    {
      try
      {
        ...
        listener.OnFraud(
          JsonConvert.DeserializeObject<CustomerVerification>(message),
