...
/// <summary>
/// Kontroler, który dla żądania HTTP z metodą POST, w ciele
/// którego znajdzie się obiekt z klientem w postaci JSONa,
/// zweryfikuje czy dana osoba jest oszustem czy też nie.
/// </summary>
[ApiController]
[Route("[controller]")]
public class FraudController : ControllerBase
{
  ...
  /// <summary>
  /// Metoda, która zostanie uruchomiona w momencie uzyskania
  /// odpowiedniego żądania HTTP.
  /// </summary>
  ...
  public async Task<IActionResult> FraudCheck(Customer person)
  {
    ...
    var result = await _customerVerifier.Verify(person);
