...
public class ApplicationTests
{
  ...
  {
    using var devApplication = await StartDevApplication();
  ...
  {
    using var host = await StartDevApplication();
  ...
  private static async Task<DevApplication> StartDevApplication()
  {
    var devApplication = await DevApplication.StartNew();
    await devApplication.AddTestData();
...
internal class DevApplication : IDisposable
{
  ...
  public Task AddTestData()
  {
    ...
    return scope.ServiceProvider.GetRequiredService<IVerificationRepository>()
      .SaveAsync(
