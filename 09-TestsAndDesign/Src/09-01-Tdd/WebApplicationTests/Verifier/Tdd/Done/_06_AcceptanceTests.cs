...
public class _06_AcceptanceTests
{
  [Test]
  ...
  private static async Task<VerificationResult> VerifyClient(
    IFlurlClient flurlClient, Client client)
  {
    return await flurlClient.Request("fraud/fraudCheck")
      ...
      .ConfigureWebHostDefaults(builder =>
        builder
          ...
          .ConfigureTestServices(services => 
            services.AddTransient<DoneFraudVerifier>()))
      .Build();
  }
}